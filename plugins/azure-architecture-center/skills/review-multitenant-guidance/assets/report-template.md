...
| **Azure Service** | <!-- name of the Azure service --> |
| **Last Review Date** | <!-- ms.date value from front matter (mm/dd/yyyy) --> |
...
| Source | Search Terms | Results Found |
|--------|-------------|---------------|
...
| Status | Change Type | Reason | Date Added | Reference Doc |
|--------|-------------|--------|------------|---------------|
| <!-- ✅ ➡️ ❌ ❓ ⛔ --> | <!-- Feature / Improvement / Bug Fix --> | <!-- Why it matters in a multitenant context --> | <!-- yyyy-mm-dd --> | <!-- [Title](URL) --> |
...
<!-- If updates are recommended, offer to provide change text for each
finding marked ➡️ or ❌. Otherwise, remove this section. -->
